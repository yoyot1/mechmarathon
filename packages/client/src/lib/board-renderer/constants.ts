import type { TileType, Direction } from '@mechmarathon/shared';
...
export const TILE_SYMBOLS: Partial<Record<TileType, string>> = {
  gear_cw: '\u21BB',
  gear_ccw: '\u21BA',
  repair: '+',
  laser: '\u26A1',
...
export const CONVEYOR_ARROWS: Record<Direction, string> = {
  north: '\u2191',
  south: '\u2193',
  east: '\u2192',
  west: '\u2190',
...
export const EXPRESS_CONVEYOR_ARROWS: Record<Direction, string> = {
  north: '\u21C8',
  south: '\u21CA',
  east: '\u21C9',
  west: '\u21C7',
...
export const DIRECTION_RADIANS: Record<Direction, number> = {
  north: 0,
  east: Math.PI / 2,
  south: Math.PI,
  west: -Math.PI / 2,
