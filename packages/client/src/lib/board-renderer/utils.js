import { TILE_SIZE, TILE_GAP, DIRECTION_RADIANS } from './constants.js';

/** Convert board grid position to pixel center */
export function boardToPixel(pos) {
...
export function boardToPixelTopLeft(pos) {
  const cellPitch = TILE_SIZE + TILE_GAP;
  return {
    x: pos.x * cellPitch,
    y: pos.y * cellPitch,
...
export function directionToRadians(dir) {
